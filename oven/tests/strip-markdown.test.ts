...
async function runStripMarkdown(input: string, format: "tts" | "plain" = "tts", preserveStructure: boolean = false): Promise<string> {
  const args = ["run", "/Users/adamhall/PersonalConfigs/oven/bin/strip-markdown.ts", "--format", format];
  ...
  describe("TTS format", () => {
    describe("basic markdown removal", () => {
      ...
      test("removes inline code formatting", async () => {
        ...
        expect(await runStripMarkdown("Use the `console.log()` function")).toBe("Use the console.log() function");
      });
    ...
    describe("link and image handling", () => {
      test("extracts link text and removes URLs", async () => {
        ...
        expect(await runStripMarkdown("Visit [our website](https://example.com) for more info")).toBe("Visit our website for more info");
      });
  ...
  describe("Plain format", () => {
    describe("basic markdown removal", () => {
      ...
      test("removes bold formatting", async () => {
        ...
        expect(await runStripMarkdown("This is **very important** text", "plain")).toBe("This is very important text");
      });
      ...
      test("removes inline code formatting", async () => {
        ...
        expect(await runStripMarkdown("Use the `console.log()` function", "plain")).toBe("Use the console.log() function");
      });
    ...
    describe("link and image handling", () => {
      test("extracts link text and removes URLs", async () => {
        ...
        expect(await runStripMarkdown("Visit [our website](https://example.com) for more info", "plain")).toBe("Visit our website for more info");
      });
...
![Screenshot](screenshot.png)`;
      ...
      expect(result).toBe("Project Title.. This is a great project with amazing features.. Installation.. Code block: npm install project. Features.. • Feature 1. • Feature 2. • Feature 3. Check out our documentation for more info.. !Screenshot");
    });
