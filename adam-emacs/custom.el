...
(custom-set-faces
 ...
 '(outline-1 ((t (:background "#23272e" :foreground "#51afef" :weight bold :height 1.2))))
 '(rjsx-tag ((t (:foreground "#65B8FF" :weight bold))))
 '(vertical-border ((t (:background "black" :foreground "#181818")))))
